...
static void PacSumFloatCascadeScatterFloat(Vector inputs[], AggregateInputData &aggr, idx_t input_count, Vector &states,
                                           idx_t count) {
...
template <class FLOAT_TYPE>
static void PacSumFloatFinalize(Vector &states, AggregateInputData &aggr_input, Vector &result, idx_t count,
                                idx_t offset) {
...
using PacSumIntegerState =
    typename std::conditional<std::is_signed<INPUT_TYPE>::value, PacSumSignedState, PacSumUnsignedState>::type;
...
template <class INPUT_TYPE, class ACC_TYPE>
static void PacSumIntegerFinalize(Vector &states, AggregateInputData &aggr_input, Vector &result, idx_t count,
                                  idx_t offset) {
...
#define ADD_PAC_SUM_INT(INPUT_TYPE, ACC_TYPE, RESULT_TYPE, ScatterFn, CombineFn, FinalizeFn, UpdateFn)                 \
	pac_sum_set.AddFunction(AggregateFunction(                                                                         \
	    "pac_sum", {LogicalType::UBIGINT, INPUT_TYPE}, RESULT_TYPE, PacSumIntegerStateSize<ACC_TYPE, ACC_TYPE>,        \
	    PacSumIntegerInitialize<ACC_TYPE, ACC_TYPE>, ScatterFn, CombineFn, FinalizeFn,                                 \
	    FunctionNullHandling::DEFAULT_NULL_HANDLING, UpdateFn, PacSumBind));                                           \
	pac_sum_set.AddFunction(AggregateFunction(                                                                         \
	    "pac_sum", {LogicalType::UBIGINT, INPUT_TYPE, LogicalType::DOUBLE}, RESULT_TYPE,                               \
	    PacSumIntegerStateSize<ACC_TYPE, ACC_TYPE>, PacSumIntegerInitialize<ACC_TYPE, ACC_TYPE>, ScatterFn, CombineFn, \
	    FinalizeFn, FunctionNullHandling::DEFAULT_NULL_HANDLING, UpdateFn, PacSumBind))

	// Signed integers (accumulate to hugeint_t, return HUGEINT)
	pac_sum_set.AddFunction(
	    AggregateFunction("pac_sum", {LogicalType::UBIGINT, LogicalType::TINYINT}, LogicalType::HUGEINT,
	                      PacSumIntegerStateSize<int8_t, hugeint_t>, PacSumIntegerInitialize<int8_t, hugeint_t>,
	                      PacSumScatterTinyInt, PacSumCombineTinyInt, PacSumFinalizeTinyInt,
	                      FunctionNullHandling::DEFAULT_NULL_HANDLING, PacSumUpdateTinyInt, PacSumBind));
	pac_sum_set.AddFunction(AggregateFunction(
	    ...
	    PacSumCombineTinyInt, PacSumFinalizeTinyInt, FunctionNullHandling::DEFAULT_NULL_HANDLING, PacSumUpdateTinyInt,
	    PacSumBind));

	// BOOLEAN treated as TINYINT (like DuckDB's SUM)
	pac_sum_set.AddFunction(
	    AggregateFunction("pac_sum", {LogicalType::UBIGINT, LogicalType::BOOLEAN}, LogicalType::HUGEINT,
	                      PacSumIntegerStateSize<int8_t, hugeint_t>, PacSumIntegerInitialize<int8_t, hugeint_t>,
	                      PacSumScatterTinyInt, PacSumCombineTinyInt, PacSumFinalizeTinyInt,
	                      FunctionNullHandling::DEFAULT_NULL_HANDLING, PacSumUpdateTinyInt, PacSumBind));
	pac_sum_set.AddFunction(AggregateFunction(
	...
	pac_sum_set.AddFunction(
	    AggregateFunction("pac_sum", {LogicalType::UBIGINT, LogicalType::SMALLINT}, LogicalType::HUGEINT,
	                      PacSumIntegerStateSize<int16_t, hugeint_t>, PacSumIntegerInitialize<int16_t, hugeint_t>,
	                      PacSumScatterSmallInt, PacSumCombineSmallInt, PacSumFinalizeSmallInt,
	                      FunctionNullHandling::DEFAULT_NULL_HANDLING, PacSumUpdateSmallInt, PacSumBind));
	pac_sum_set.AddFunction(AggregateFunction(
	...
	pac_sum_set.AddFunction(
	    AggregateFunction("pac_sum", {LogicalType::UBIGINT, LogicalType::INTEGER}, LogicalType::HUGEINT,
	                      PacSumIntegerStateSize<int32_t, hugeint_t>, PacSumIntegerInitialize<int32_t, hugeint_t>,
	                      PacSumScatterInteger, PacSumCombineInteger, PacSumFinalizeInteger,
	                      FunctionNullHandling::DEFAULT_NULL_HANDLING, PacSumUpdateInteger, PacSumBind));
	pac_sum_set.AddFunction(AggregateFunction(
	    ...
	    PacSumCombineInteger, PacSumFinalizeInteger, FunctionNullHandling::DEFAULT_NULL_HANDLING, PacSumUpdateInteger,
	    PacSumBind));

	pac_sum_set.AddFunction(
	    AggregateFunction("pac_sum", {LogicalType::UBIGINT, LogicalType::BIGINT}, LogicalType::HUGEINT,
	                      PacSumIntegerStateSize<int64_t, hugeint_t>, PacSumIntegerInitialize<int64_t, hugeint_t>,
	                      PacSumScatterBigInt, PacSumCombineBigInt, PacSumFinalizeBigInt,
	                      FunctionNullHandling::DEFAULT_NULL_HANDLING, PacSumUpdateBigInt, PacSumBind));
	pac_sum_set.AddFunction(AggregateFunction(
	    ...
	    PacSumCombineBigInt, PacSumFinalizeBigInt, FunctionNullHandling::DEFAULT_NULL_HANDLING, PacSumUpdateBigInt,
	    PacSumBind));

	pac_sum_set.AddFunction(
	    AggregateFunction("pac_sum", {LogicalType::UBIGINT, LogicalType::HUGEINT}, LogicalType::HUGEINT,
	...
	pac_sum_set.AddFunction(AggregateFunction(
	    ...
	    PacSumIntegerStateSize<hugeint_t, hugeint_t>, PacSumIntegerInitialize<hugeint_t, hugeint_t>,
	    PacSumScatterHugeInt, PacSumCombineHugeInt, PacSumFinalizeHugeInt, FunctionNullHandling::DEFAULT_NULL_HANDLING,
	    PacSumUpdateHugeInt, PacSumBind));

	// Unsigned integers (accumulate to hugeint_t like DuckDB's SUM, return HUGEINT)
	pac_sum_set.AddFunction(
	    AggregateFunction("pac_sum", {LogicalType::UBIGINT, LogicalType::UTINYINT}, LogicalType::HUGEINT,
	...
	pac_sum_set.AddFunction(AggregateFunction(
	    ...
	    PacSumIntegerStateSize<uint8_t, hugeint_t>, PacSumIntegerInitialize<uint8_t, hugeint_t>, PacSumScatterUTinyInt,
	    PacSumCombineUTinyInt, PacSumFinalizeUTinyInt, FunctionNullHandling::DEFAULT_NULL_HANDLING,
	    PacSumUpdateUTinyInt, PacSumBind));

	pac_sum_set.AddFunction(
	    AggregateFunction("pac_sum", {LogicalType::UBIGINT, LogicalType::USMALLINT}, LogicalType::HUGEINT,
	...
	pac_sum_set.AddFunction(
	    AggregateFunction("pac_sum", {LogicalType::UBIGINT, LogicalType::UINTEGER}, LogicalType::HUGEINT,
	...
	pac_sum_set.AddFunction(
	    AggregateFunction("pac_sum", {LogicalType::UBIGINT, LogicalType::UBIGINT}, LogicalType::HUGEINT,
	...
	pac_sum_set.AddFunction(AggregateFunction(
	    ...
	    PacSumIntegerStateSize<uint64_t, hugeint_t>, PacSumIntegerInitialize<uint64_t, hugeint_t>, PacSumScatterUBigInt,
	    PacSumCombineUBigInt, PacSumFinalizeUBigInt, FunctionNullHandling::DEFAULT_NULL_HANDLING, PacSumUpdateUBigInt,
	    PacSumBind));

	// UHUGEINT uses float state and returns DOUBLE (like DuckDB's SUM)
	pac_sum_set.AddFunction(AggregateFunction(
	    "pac_sum", {LogicalType::UBIGINT, LogicalType::UHUGEINT}, LogicalType::DOUBLE, PacSumFloatStateSize<double>,
	    PacSumFloatInitialize<double>, PacSumScatterUHugeIntToDouble, PacSumCombineDouble, PacSumFinalizeDouble,
	...
	pac_sum_set.AddFunction(AggregateFunction(
	    ...
	    PacSumFloatStateSize<double>, PacSumFloatInitialize<double>, PacSumScatterUHugeIntToDouble, PacSumCombineDouble,
	    PacSumFinalizeDouble, FunctionNullHandling::DEFAULT_NULL_HANDLING, PacSumUpdateUHugeIntToDouble, PacSumBind));
	...
	pac_sum_set.AddFunction(
	    AggregateFunction("pac_sum", {LogicalType::UBIGINT, LogicalType::FLOAT}, LogicalType::DOUBLE,
	                      ...
	                      PacSumFloatCascadeCombine, PacSumFloatCascadeFinalize,
	                      FunctionNullHandling::DEFAULT_NULL_HANDLING, PacSumFloatCascadeUpdateFloat, PacSumBind));
	pac_sum_set.AddFunction(
	    AggregateFunction("pac_sum", {LogicalType::UBIGINT, LogicalType::FLOAT, LogicalType::DOUBLE},
	                      LogicalType::DOUBLE, PacSumFloatCascadeStateSize, PacSumFloatCascadeInitialize,
	                      PacSumFloatCascadeScatterFloat, PacSumFloatCascadeCombine, PacSumFloatCascadeFinalize,
	                      FunctionNullHandling::DEFAULT_NULL_HANDLING, PacSumFloatCascadeUpdateFloat, PacSumBind));
	...
	pac_sum_set.AddFunction(
	    AggregateFunction("pac_sum", {LogicalType::UBIGINT, LogicalType::DOUBLE}, LogicalType::DOUBLE,
	                      ...
	                      PacSumFloatCascadeCombine, PacSumFloatCascadeFinalize,
	                      FunctionNullHandling::DEFAULT_NULL_HANDLING, PacSumFloatCascadeUpdateDouble, PacSumBind));
	pac_sum_set.AddFunction(
	    AggregateFunction("pac_sum", {LogicalType::UBIGINT, LogicalType::DOUBLE, LogicalType::DOUBLE},
	                      LogicalType::DOUBLE, PacSumFloatCascadeStateSize, PacSumFloatCascadeInitialize,
	                      PacSumFloatCascadeScatterDouble, PacSumFloatCascadeCombine, PacSumFloatCascadeFinalize,
	                      FunctionNullHandling::DEFAULT_NULL_HANDLING, PacSumFloatCascadeUpdateDouble, PacSumBind));
